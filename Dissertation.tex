...
% (MUST come *before* caption/subcaption)
% NOTE: tocloft is already loaded by psuthesis.cls with [subfigure] option
% DO NOT load it again here as it causes LOF/LOT generation issues
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \usepackage{tocloft}  % REMOVED - already loaded by psuthesis.cls
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Other formatting and utilities
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{xspace}
\usepackage{url}
% Allow URLs to break at any alphanumeric character to prevent overflow
\def\UrlBreaks{\do\/\do-\do\_\do\.\do\@\do\?\do\&\do\=\do\+\do\:\do\a\do\b\do\c\do\d\do\e\do\f\do\g\do\h\do\i\do\j\do\k\do\l\do\m\do\n\do\o\do\p\do\q\do\r\do\s\do\t\do\u\do\v\do\w\do\x\do\y\do\z\do\A\do\B\do\C\do\D\do\E\do\F\do\G\do\H\do\I\do\J\do\K\do\L\do\M\do\N\do\O\do\P\do\Q\do\R\do\S\do\T\do\U\do\V\do\W\do\X\do\Y\do\Z\do\0\do\1\do\2\do\3\do\4\do\5\do\6\do\7\do\8\do\9}
\usepackage{cite}
\usepackage{comment}

% NOTE: algorithm and algpseudocode are already loaded above (lines 144-145)
% Do NOT load algorithmic - it conflicts with algpseudocode
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Prevent overfull hboxes (text/URLs overshooting margins)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tolerance=1500           % Allow more flexibility in word spacing
\emergencystretch=5em     % Add extra stretch to prevent overfull boxes
\hfuzz=3pt                % Suppress warnings for boxes overfull by < 3pt
\hbadness=10000           % Suppress underfull hbox warnings

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Your macros and custom commands
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{macros}
...
% \newcommand{\cmark}{\ding{51}}
% \newcommand{\xmark}{\ding{55}}
% % \usepackage{subfig}  % Commented - conflicts with subcaption
...
% \usepackage{algpseudocode}
% \usepackage{wrapfig}
% % \usepackage{tikz}  % Already loaded below
% \usepackage{pgfplots}  % For plotting
% \pgfplotsset{compat=1.18}
% \usepackage{comment}
% % \usepackage{multirow}  % Already loaded below
% \usepackage{gensymb}
% \usepackage{caption}
% \usepackage{subcaption}
% \usepackage{enumitem}  % For better list formatting
% \usepackage{xspace}  % For better spacing in custom commands
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Additional packages needed for dissertation chapters
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % For tables and advanced formatting
% \usepackage{tabularx}
% \usepackage{array}
% \usepackage{multirow}  % For spanning rows in tables
% \usepackage{rotating}
% \usepackage{diagbox}  % For diagonal cells in tables
...
% % For better float control
% \usepackage{float}
% \usepackage{placeins}  % For \FloatBarrier

% % For better paragraph control (careful with this in thesis class)
% % \usepackage{parskip}  % Commented as it may conflict with thesis formatting

% % For hyperlinks (should be loaded last)
% \usepackage[colorlinks=true,linkcolor=blue,citecolor=blue,urlcolor=blue]{hyperref}

% After hyperref, fix the chapter counter issue if needed
\renewcommand{\theHchapter}{\thepart.\thechapter}

% Custom commands used in the dissertation
...
%%%%%%%%%%%%%%%%
% Title
% \title{Improving Performance and Energy Efficiency for On-Device Visual Computing}

% \title{Overcoming Resource Limitations: Improving Performance and Energy Efficiency for On-Device Visual Computing}

\title{From Intermittent to Intelligent: Enabling Machine Learning in Power-Constrained Computing Systems}
...
\advisor[Dissertation Co-Chair \& Dissertation Advisor]
		{Mahmut Taylan Kandemir}
		{Distinguished Professor and Head of the Department, Computer Science and Engineering}

\readerone[Dissertation Co-Chair \& Dissertation Advisor]
		{Jack Sampson}
		{Associate Professor, Computer Science and Engineering}

\readertwo[Major Field Member]
		{Vijaykrishnan Narayanan}
		{Evan Pugh Professor and A. Robert Noll Chair Professor, Computer Science and Engineering}

\readerthree[Major Field Member]
		{Chitaranjan Das}
		{Distinguished Professor, Computer Science and Engineering}


\readerfour[Outside Unit \& Field Member]
		{Soundar Kumara}
		{Allen E. Pearce and Allen M. Pearce Professor of Industrial Engineering, Harold and Inge Marcus Department of Industrial and Manufacturing Engineering}
...
%%%%%%%%%%%%%%%%%%%%%%
% Chapters
\include{Chapter-1/chapter1}      % Chapter 1: Introduction
\include{Chapter-2/chapter2}      % Chapter 2: Origin and Seeker (Distributed Inference on Energy-Harvesting WSNs)
\include{Chapter-4/chapter4}      % Chapter 3 (folder 4): NExUME (Training Under Intermittency)
\include{Chapter-5/Chapter-5}     % Chapter 4 (folder 5): LREyE (Hardware-Aware Analog Neural Network Co-Design)
\include{Chapter-6/chapter6}      % Chapter 5 (folder 6): Uṡás (Solar-Powered Continuous Learning at the Edge)
\include{Chapter-7/Chapter-7}     % Chapter 6 (folder 7): Related Work
\include{Chapter-8/chapter8}      % Chapter 7 (folder 8): Conclusions and Future Work
...
% Appendix C contains supplementary material for NExUME (Chapter 4)
...
% bibtex, then this section should look something like:
	...
	\bibliography{references_rishabh,references_ziyu,Chapter-2/Origin-DATE21-CameraReady/References,Chapter-2/Seeker-ASPLOS26/references,Chapter-4/IntermittentTrainingICLR25CameraReady/refs,Chapter-4/IntermittentTrainingICLR25CameraReady/iclr2025_conference,Chapter-5/LREyE-MICRO/sample-base,Chapter-6/Usas-HPCA24-CameraReady/refs,Chapter-8/ParticipationGamesICML25/example_paper}
	\end{singlespace}
