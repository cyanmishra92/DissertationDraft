...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tolerance=1000           % Allow more flexibility in word spacing
\emergencystretch=3em     % Add extra stretch to prevent overfull boxes
\hfuzz=2pt                % Suppress warnings for boxes overfull by < 2pt
