...
\subfloat[Number of layers trained vs. oracle selection.]{
  \includegraphics[width=0.95\linewidth]{Chapter-6/Usas-HPCA24-CameraReady/figs/4.pdf}
  \label{fig:usas-layers}
}

\subfloat[Batch-size selection and convergence behavior.]{
  \includegraphics[width=0.95\linewidth]{Chapter-6/Usas-HPCA24-CameraReady/figs/5.pdf}
  \label{fig:usas-config}
}

\subfloat[Time distribution between exemplar selection and training.]{
  \includegraphics[width=0.95\linewidth]{Chapter-6/Usas-HPCA24-CameraReady/figs/6.pdf}
  \label{fig:usas-extr}
}
