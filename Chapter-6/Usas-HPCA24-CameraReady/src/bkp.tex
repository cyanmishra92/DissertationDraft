...
%%%%%%%%%%%---SETME-----%%%%%%%%%%%%%
%\newcommand{\microsubmissionnumber}{255}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%---SETME-----%%%%%%%%%%%%%
%\title{U\d{s}\'{a}s: A Sustainable Continuous-Learning Framework for Video Analytics at Edge Servers %\vspace{-64pt}}
\title{\US{}: A Sustainable Continuous-Learning Framework for  Edge/ Edge Servers}
\author{~}
%\author{~}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
